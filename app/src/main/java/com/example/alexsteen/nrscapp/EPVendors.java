...
public class EPVendors extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_epvendors);

        LinearLayout layout = (LinearLayout) findViewById(R.id.epVendors);
        ...
        for(int i = 0; i < features.size(); i++) {
            ...
            j.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    switch(view.getId()){
                        case 0:
                            i = new Intent(EPVendors.this, Restaurant1.class);
                            startActivity(i);
                            break;
                        //Second button click
                        case 1:
                            i = new Intent(EPVendors.this, Restaurant2.class);
                            startActivity(i);
                            break;
                }
            }});
